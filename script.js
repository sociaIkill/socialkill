    ...
    content: `
        <div style="color: #000; font-family: 'Inter', sans-serif;">
            <div style="display: flex; gap: 30px; margin-bottom: 30px; align-items: flex-start; flex-wrap: wrap;">
                <img src="img/ddostool.png" style="width: 100%; max-width: 350px; height: 200px; object-fit: cover; border: 1px solid #000; filter: grayscale(1) contrast(1.2);">
                <div style="flex: 1; min-width: 250px;">
                    ...
                    <p style="font-size: 14px; line-height: 1.6; opacity: 0.8;">
                        Профессиональный инструмент для стресс-тестирования веб-инфраструктур от sociaIkill. Асинхронный движок на aiohttp с автоматической ротацией прокси и интеллектуальным удалением мёртвых узлов. Мониторинг RPS в реальном времени.
                    </p>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; border-top: 1px solid rgba(0,0,0,0.1); padding-top: 25px;">
                <div>
                    ...
                    <ul style="font-size: 13px; list-style: none; padding: 0; line-height: 2;">
                        <li>• Multi-threaded DDoS</li>
                        <li>• Proxy-chain Support</li>
                        <li>• Auto-dead Proxy Removal</li>
                        <li>• Real-time RPS Monitor</li>
                    </ul>
                </div>
                <div>
                    <h4 style="font-size: 12px; font-weight: 900; text-transform: uppercase; margin-bottom: 12px;">> TECHNICAL_DATA:</h4>
                    <ul style="font-size: 13px; list-style: none; padding: 0; line-height: 2;">
                        <li>• Engine: Python / aiohttp</li>
                        <li>• Max RPS: 1000+/li>
                        <li>• Proxy Protocol: HTTP</li>
                        <li>• UI: PySide6</li>
                    </ul>
                </div>
            </div>
